...
def cycle_over_all_bodies(function):  
    ...
    def for_cycle(*args):
        for index,b in enumerate(args[0].bodies):
            function(*args,b,index)
        return
...
class system:
    ...
    def __init__(self, ms, r0s, v0s, dt):
        ...
        self.special_body = self.bodies[0] 
    ...
    @cycle_over_all_bodies
    def check_collisions(self, *args):
        body = args[0]
        index = args[1]
    ...
    @cycle_over_all_bodies   
    def bounce_on_border(self, *args):     
        L = args[0]
        body = args[1]
        loc = body.pos
        vel = body.velocity
    ...
    @property
    def special_body(self):
        print("getting...")
        return self._special_body
    
    @special_body.setter
    def special_body(self, body):
        print("setting...")
        mass = 100
        body.mass = mass
        body.radius = self.set_radius(mass) 
        self._special_body = body 
