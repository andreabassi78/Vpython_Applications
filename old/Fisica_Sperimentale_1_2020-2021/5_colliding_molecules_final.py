...
@author: Andrea Bassi
"""
from vpython import graph, gcurve, vector, curve, color, sphere, mag, rate, dot, attach_trail 
...
t = 0
#graph(xtitle = 'time (s)', ytitle = 'velocity (m/s)')
...
while t<2:   
    ...
    # non stiamo considerendo le collisioni tra le particelle
